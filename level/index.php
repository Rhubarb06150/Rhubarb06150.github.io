...
<body id="body">
    ...
    <div class="header" id="header">
        <a href="/" style="width: max-content;">
            <img src="/images/logos/smbxland.png" height="106" width="568" style="margin-left: 32px;" alt="website logo" id="website-logo">
        </a>
    </div>
    <div class="page_structure">
        <div class="sidebar">
            ...
            <div class="menu_options">
                ...
                <span class="menu_options_link"><a href="/lvlupload/">Upload a level</a></span>
            </div>
    ...
    <footer>
        <div class="footer_content">
            <center>
                <p>SMBX Land is not affiliated with Nintendo or any other company. All nintendo content belongs to
                    Nintendo, all the rest belongs to SMBX Land.</p>
            </center>
        </div>
    </footer>
</body>
